...
# All rights reserved.
# 
# $Workfile: compare_gm20_client_data.ksh$ 
#
# $Revision: 8$        $Date: 12/30/2009 11:52:57 AM$
#
#
# Description:  <ADD>
#
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MAPPER: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MD_ODC_OH_PCT: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MODELLED_COEFF: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MODELLED_INCLUSION: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MODELLED_STANDARDIZE: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "MODELLED_CPP_FENCE: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "PAP_CLINICAL_PROC_COST(without DE PRICE): #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "PAP_CLINICAL_PROC_COST(with DE PRICE): #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "PAP_INSTITUTION_PROC_COST: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "PAP_OVERHEAD: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "G50_PAP_CLINICAL_PROC_COST(without DE PRICE): #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "G50_PAP_CLINICAL_PROC_COST(with DE PRICE): #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "G50_PAP_OVERHEAD: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "G50_COMPANY_PAP_ODC_COST: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "G50_IP_STUDY_PRICE: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "COMPANY_PAP_ODC_COST: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "INDUSTRY_PAP_ODC_COST: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "OWN_INVESTIG: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "OWN_PROTOCOL: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "OWN_ODC: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "OWN_PROCEDURE: #rows mismatch: $var4"
  fi
fi
...
EOF`
  ...
  select $var1-$var3 from dual;
EOF`
   echo "OWN_SITE: #rows mismatch: $var4"
  fi
fi
...
#
# $Log: 
#  8    DevTSM    1.7         12/30/2009 11:52:57 AMDebashish Mishra  
#  7    DevTSM    1.6         12/3/2008 10:32:04 AMDebashish Mishra  
#  6    DevTSM    1.5         2/27/2008 2:15:49 PM Debashish Mishra updated for
#       own table structures
#  5    DevTSM    1.4         2/22/2008 10:55:22 AMDebashish Mishra  
#  4    DevTSM    1.3         9/14/2007 10:03:49 AMDebashish Mishra  
#  3    DevTSM    1.2         3/17/2007 6:38:55 AM Debashish Mishra  
#  2    DevTSM    1.1         9/18/2006 11:10:45 PMDebashish Mishra   
#  1    DevTSM    1.0         9/29/2005 10:17:46 AMDebashish Mishra 
# $
# 
#############################################################
