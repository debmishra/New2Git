...
# All rights reserved.
# 
# $Workfile: compare_gm20_client_data_all.ksh$ 
#
# $Revision: 1$        $Date: 11/24/2009 4:57:58 PM$
#
#
# Description:  <ADD>
#
...
if test $var1 -ne $var2
   then
     echo "INSTITUTION_OVERHEAD : $username#Total no. of rows do not match"
else
...
if test $var1 -ne $var2
   then
     echo "IP_STUDY_PRICE : $username#Total no. of rows do not match"
else
...
if test $var1 -ne $var2
   then
     echo "MAPPER : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "MD_ODC_OH_PCT : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "MODELLED_COEFF : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "MODELLED_INCLUSION : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "MODELLED_STANDARDIZE : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "MODELLED_UPFENCE : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "PAP_CLINICAL_PROC_COST(without DE PRICE) : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "PAP_CLINICAL_PROC_COST(with DE PRICE) : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "PAP_INSTITUTION_PROC_COST : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "PAP_OVERHEAD : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "G50_PAP_CLINICAL_PROC_COST(without DE PRICE) : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "G50_PAP_CLINICAL_PROC_COST(with DE PRICE) : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "G50_PAP_OVERHEAD : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "G50_COMPANY_PAP_ODC_COST : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "G50_IP_STUDY_PRICE : $username#Total no. of rows do not match"
else
...
if test $var1 -ne $var2
   then
     echo "COMPANY_PAP_ODC_COST : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "INDUSTRY_PAP_ODC_COST : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "OWN_INVESTIG : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "OWN_PROTOCOL : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "OWN_ODC : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "OWN_PROCEDURE : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
if test $var1 -ne $var2
   then
     echo "OWN_SITE : $username#Total no. of rows do not match"
else
  var3=`sqlplus -s $1 << EOF
  set pages 0
  set hea off
...
#
# $Log: 
#  1    DevTSM    1.0         11/24/2009 4:57:58 PMMahesh Pasupuleti 
# $
# 
#############################################################
