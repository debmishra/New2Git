...
/
/***Add below on 06-07-2012****/
/***Applied on all SQA,DEVL databases ****/
alter table tsm10.tspd_set drop constraint TSPD_SET_TYPE_CHECK;
alter table tsm10.tspd_set add constraint TSPD_SET_TYPE_CHECK check (OBJ_TYPE IN ('Objective', 'Endpoint', 'Restriction'));