...
rm -rf $load_ctl_dir/ipm_phase2.dat

for filename in `ls *.txt`
do
cat $filename | grep -v country >> $load_ctl_dir/ipm_phase2.dat
done


$ORA_HOME/bin/sqlplus -s $connect_string << EOF
truncate table ipm_phase2to4;
exit;
EOF

$ORA_HOME/bin/sqlldr \
CONTROL=$dos_load_ctl_dir\\ipm_phase2.ctl, LOG=$dos_load_ctl_dir\\ipm_phase2.log, \
BAD=$dos_load_ctl_dir\\ipm_phase2.bad, \
