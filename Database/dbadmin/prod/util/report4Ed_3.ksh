...
spool /export/home/oracle/log/Ed/TrialPerUser.csv
...
mv /export/home/oracle/log/Ed/TrialPerUser.csv /export/home/oracle/log/Ed/TrialPerUser_$(date +%m%d%y).csv

sed "s/$/`echo \\\r`/" /export/home/oracle/log/Ed/TrialPerUser_$(date +%m%d%y).csv | \
uuencode TrialPerUser_$(date +%m%d%y).csv | \
mailx -r $sender -s "Usage report - TrialPerUser" -c $cclist $mailinglist
...
#  4    DevTSM    1.3         2/15/2007 4:48:07 PM Debashish Mishra  
#  3    DevTSM    1.2         9/6/2006 9:49:57 PM  Debashish Mishra  
#  2    DevTSM    1.1         4/17/2005 9:35:04 AM Debashish Mishra  
#  1    DevTSM    1.0         3/15/2005 7:17:00 PM Debashish Mishra 
# $
# 
#############################################################
