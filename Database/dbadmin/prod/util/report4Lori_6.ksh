...
break on id
spool /export/home/oracle/log/Report4Lori2_6.txt
...
b.client_div_identifier in ('FTS2','FTG2')
...
f.client_div_identifier in ('FTS2','FTG2')
...
c.client_div_identifier in ('FTS2','FTG2')
...
b.name NOT LIKE 'fasttrack@%' AND c.client_div_identifier in('FTS2','FTG2')
...
###Training schema not used in "prod" database anymore.
###Commented on 04/22/2009
###cat /export/home/oracle/log/Report4Lori_6.txt | mailx -s "FTS2 & FTG2 in 200Training" -r $sender -c $cclist $mailinglist

cat /export/home/oracle/log/Report4Lori2_6.txt | mailx -s "FTS2 & FTG2 in 200 Prod" -r $sender -c $cclist $mailinglist
...
#  2    DevTSM    1.1         9/6/2006 9:50:00 PM  Debashish Mishra  
#  1    DevTSM    1.0         9/19/2005 4:23:58 PM Debashish Mishra 
# $
# 
#############################################################
