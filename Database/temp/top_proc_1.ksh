...
c.client_div_id=$clientdiv_id and
a.procedure_def_id is not null
...
a.trial_budget_id=b.id and b.trial_id=c.id and
c.client_div_id=$clientdiv_id and 
a.procedure_def_id is not null) z,
procedure_def zz
where
...
c.client_div_id=$clientdiv_id and a.procedure_def_id is not null;
...
#  2    DevTSM    1.1         3/3/2005 6:36:06 AM  Debashish Mishra  
#  1    DevTSM    1.0         8/3/2004 2:50:44 PM  Debashish Mishra 
# $
# 
#############################################################
